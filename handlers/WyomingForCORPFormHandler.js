...
class WyomingForCORP extends BaseFormHandler {
    ...
    async WyomingForCORP(page, jsonData) {
        try {
            ...
            await this.fillInputByName(page, 'ctl00$MainContent$ucDetail$txtCommonShares', String(jsonData.data.Payload.Stock_Information.SI_No_Of_Shares));
            await this.clickButton(page, '#ContinueButton');
            ...
            await this.fillInputByName(page, 'ctl00$MainContent$ucParties$txtMail1', 
                jsonData.data.Payload.Incorporator_Information.Address.Inc_Address_Line1 + ', ' +
                jsonData.data.Payload.Incorporator_Information.Address.Inc_City + ', ' +
                jsonData.data.Payload.Incorporator_Information.Address.Inc_State + ', ' +
                jsonData.data.Payload.Incorporator_Information.Address.Inc_Zip_Code
            );
