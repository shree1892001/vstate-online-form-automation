...
class NevadaForLLC extends BaseFormHandler {
    constructor() {
        super();
    }
    async NevadaForLLC(page, jsonData) {
        try {
            logger.info('Navigating to New York form submission page...');
            const url = jsonData.data.State.stateUrl;
            await this.navigateToPage(page, url);
            await page.waitForSelector('a[href="#llc"]');

            // Click the anchor link
            await page.click('a[href="#llc"]');            
