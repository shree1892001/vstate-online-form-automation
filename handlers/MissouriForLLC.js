...
//    await page.select('#ctl00_ctl00_ContentPlaceHolderMain_ContentPlaceHolderMainSingle_ppBEName_txtBEName', jsonData.data.Payload.Name.CD_Legal_Name );
...
const regFields1 = [
    ...
    { label: 'txtZip', value: jsonData.data.Payload.Registered_Agent.RA_Address.RA_Zip_Code},
...
const orgFields1 = [
    ...
    { label: 'txtZip', value: jsonData.data.Payload.Organizer_Information.Org_Address.Org_Zip_Code},
