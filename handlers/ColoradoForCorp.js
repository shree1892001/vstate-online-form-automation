    ...
    async ColoradoForCorp(page, jsonData) {
        try {
            ...
            const principleaddress = [
                { label: 'streetAddress-address1', value: jsonData.data.Payload.Principal_Address.PA_Address_Line1 },
                { label: 'streetAddress-city', value: jsonData.data.Payload.Principal_Address.PA_City },
                { label: 'streetAddress-zip', value: jsonData.data.Payload.Principal_Address.PA_Zip_Code }
            ];
            await this.addInput(page, principleaddress);
            await this.clickDropdown(page,"#streetAddress-state",jsonData.data.Payload.Principal_Address.PA_State);
            await this.clickDropdown(page,"#streetAddress-country",jsonData.data.Payload.Principal_Address.PA_Country);
            
            if(jsonData.data.Payload.Principal_Address===jsonData.data.Payload.Mailing_Address){
                ...
                const principleaddress = [
                    { label: 'mailingAddress-address1', value: jsonData.data.Payload.Principal_Address.PA_Address_Line1 },
                    { label: 'mailingAddress-city', value: jsonData.data.Payload.Principal_Address.PA_City },
                    { label: 'mailingAddress-zip', value: jsonData.data.Payload.Principal_Address.PA_Zip_Code }
                ];
                await this.addInput(page, principleaddress);
                await this.clickDropdown(page,"#mailingAddress-state",jsonData.data.Payload.Principal_Address.PA_State);
                await this.clickDropdown(page,"#mailingAddress-country",jsonData.data.Payload.Principal_Address.PA_Country);
            ...
            await page.waitForSelector('input[type="radio"][name="nameTyp"]');
               ...
               console.log("Name",Name); 
                ...
                const registered_agent_fields = [
                    ...
                    { label: 'streetAddress-zip', value: jsonData.data.Payload.Registered_Agent.RA_Address.RA_Zip_Code }
                ];
                ...
                if(jsonData.data.Payload.Registered_Agent.RA_Address ===jsonData.data.Payload.Registered_Agent.MA_Address){
                    ...
                    const registered_agent_fields = [
                        ...
                        { label: 'mailingAddress-zip', value: jsonData.data.Payload.Registered_Agent.RA_Address.RA_Zip_Code }
                    ];
                    await this.addInput(page, registered_agent_fields);
               ...
               await page.waitForSelector("#saveNextId",{visible:true,timeout:12000});
                ...
                const organizeraddress = [
                  ...
                  { label: 'address-zip', value: jsonData.data.Payload.Organizer_Information.Org_Address.Org_Zip_Code }
              ];
