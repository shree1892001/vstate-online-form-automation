...
for (const label of labels) {
   ...
   // await this.selectRadioButtonByLabel(page, 'Perpetual / Ongoing');
            ...
            await this.fillInputByName(newPage,"CITY",jsonData.data.Payload.Principal_Address.PA_City);
            await this.fillInputByName(newPage,"POSTAL_CODE",jsonData.data.Payload.Principal_Address.PA_Zip_Code);
           ...
           await this.clickDropdown(newPage,"#field-addr-state-HyRmVxJsW",jsonData.data.Payload.Principal_Address.PA_State);
...
await newPage.type('input[aria-label="Mailing address: ZIP code"]',jsonData.data.Payload.Principal_Address.PA_Zip_Code);  
