    ...
    await page.click('#basedInHawaii_true'); 
            ...
            const registered_agent_fields1= [
                ...
                await page.evaluate((jsonData) => {
                    ...
                    const option = Array.from(dropdown.options).find(opt => opt.text === jsonData.data.Payload.Incorporator_Information.Inc_Address.Inc_Country.toUpperCase());
                ...
                await page.evaluate((jsonData) => {
                    ...
                    if (streetField) {
                        streetField.value = jsonData.data.Payload.Incorporator_Information.Inc_Address.Inc_Address_Line1;
                    ...
                    if (cityField) {
                        cityField.value = jsonData.data.Payload.Incorporator_Information.Inc_Address.Inc_City;
                    ...
                    const option = Array.from(dropdown.options).find(opt => opt.text ===jsonData.data.Payload.Incorporator_Information.Inc_Address.Inc_State.toUpperCase());
                ...
                await page.evaluate((jsonData) => {
                    const dropdown = document.querySelector('[id="incorporators[0].address.state"]');
                    const option = Array.from(dropdown.options).find(opt => opt.text === jsonData.data.Payload.Incorporator_Information.Inc_Address.Inc_State);
                ...
                await page.evaluate((jsonData) => {
                    ...
                    if(dropdown){
                        dropdown.value=jsonData.data.Payload.Incorporator_Information.Inc_Address.Inc_Zip_Code;
                    }
                ...
                //   await page.type('input[name="managersOrMembers[0].address.zip"]', jsonData.data.Payload.Memeber_or_Manager_Details.Address.MM_Zip_Code);
                   ...
                   await  page.click('#hasMembers_false'); 
                }
