...
class PennsylvaniaForLLC extends BaseFormHandler {
    constructor() {
        super();
    }
    async PennsylvaniaForLLC(page, jsonData) {
        try {
            logger.info('Navigating to New York form submission page...');
            const url = jsonData.data.State.stateUrl;
            await this.navigateToPage(page, url);
            await page.waitForSelector('button.btn.btn-default.login-link');
  await page.click('button.btn.btn-default.login-link');
...
module.exports = PennsylvaniaForLLC;
